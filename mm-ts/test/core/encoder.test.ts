import { encodeNode, decodeToValue, mm } from '../../src/core/index.js';
import { ValueType } from '../../src/ir/value-type.js';
import { Tag } from '../../src/ir/tag.js';

// npm test test/core/encoder.test.ts -- -t "should encode and decode non-empty object"
